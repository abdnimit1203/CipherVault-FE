  ...
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen border-r border-white/10 glass-nav sticky top-0 z-20">
      <div className="flex items-center h-20 px-4 border-b border-white/10">
        <Link href="/" className="flex items-center hover:opacity-90 transition-opacity w-full">
          <Image 
            src="/logo_v2.png" 
            alt="CipherVault by ABD Logo" 
            width={200} 
            height={52} 
            className="h-10 w-auto object-contain drop-shadow-[0_0_12px_rgba(0,242,254,0.35)]" 
            priority 
          />
        </Link>
      </div>
