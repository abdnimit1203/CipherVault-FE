...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0b1728] pb-12 md:pb-4 relative selection:bg-cyan-500/30">
          ...
          <form onSubmit={handleSignup}>
            ...
            <CardFooter className="flex flex-col space-y-4 pb-6 pt-2">
              ...
              <Button
                ...
                className="w-full h-11 rounded-full text-base font-medium border-white/15 bg-white/5 hover:bg-white/10 flex items-center justify-center gap-2"
              >
                {isGoogleLoading ? (
                  <>
                    <CipherLoader size="sm" />
