...
export default function DashboardPage() {
  ...
  // Mock Data
  const vaultItems = [
    { id: 1, title: "Google Account", username: "you@gmail.com", category: "Personal", icon: "G" },
    { id: 2, title: "Bank of America", username: "you@example.com", category: "Finance", icon: "B" },
    { id: 3, title: "Netflix", username: "family@example.com", category: "Entertainment", icon: "N" },
    { id: 4, title: "Work Email", username: "you@company.com", category: "Work", icon: "W" },
  ];
